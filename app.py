...
def render_floating_chat():
    ...
    chat_con.float("bottom: 20px; left: 370px; width: 400px; z-index: 99999; background-color: var(--background-color) !important; border: 1px solid var(--text-color-20); border-radius: 10px; padding: 10px;")
